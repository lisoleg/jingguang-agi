...
class ContextRotDetector:
    ...
    def _init_dependencies(self) -> None:
        ...
        # M106 — Φ 值来源
        try:
            from modules.M106_SelfReferentialLoopMonitor import SelfReferentialLoopMonitor
        ...
        try:
            from modules.M180_EqPropFHN import L2ShellInterface
        ...
        try:
            from modules.M184_LLMWikiEngine import WikiEventBus
